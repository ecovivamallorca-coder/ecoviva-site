...
const commercialLinks = {
  en: `<div class="mid-cta"><h3>Relevant renovation routes</h3><p>If the cause is linked to the building envelope, EcoViva can coordinate the appropriate renovation route.</p><div class="route-links"><a href="/en/facade-renovation-mallorca/">Facade renovation Mallorca →</a><a href="/en/roof-renovation-mallorca/">Roof renovation Mallorca →</a><a href="/en/terrace-renovation-mallorca/">Terraces & waterproofing Mallorca →</a><a href="/en/renovation-mallorca/">Complete renovation Mallorca →</a></div></div>`,
  es: `<div class="mid-cta"><h3>Rutas de reforma relacionadas</h3><p>Si la causa está relacionada con la envolvente del edificio, EcoViva puede coordinar la solución de reforma adecuada.</p><div class="route-links"><a href="/es/reforma-fachada-mallorca/">Reforma de fachada en Mallorca →</a><a href="/es/reforma-cubierta-mallorca/">Reforma de cubierta en Mallorca →</a><a href="/es/reforma-terraza-mallorca/">Terrazas e impermeabilización →</a><a href="/es/reforma-mallorca/">Reforma integral en Mallorca →</a></div></div>`,
  de: `<div class="mid-cta"><h3>Passende Renovierungsbereiche</h3><p>Liegt die Ursache in der Gebäudehülle, kann EcoViva die passende Renovierungslösung koordinieren.</p><div class="route-links"><a href="/de/fassadensanierung-mallorca/">Fassadensanierung Mallorca →</a><a href="/de/dachsanierung-mallorca/">Dachsanierung Mallorca →</a><a href="/de/terrassensanierung-mallorca/">Terrassen & Abdichtung →</a><a href="/de/renovierung-mallorca/">Komplette Renovierung Mallorca →</a></div></div>`
};
